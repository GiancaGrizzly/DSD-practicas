...
class Client(Iface):
    ...
    def exp(self, num1, num2):
        ...
        """
        self.send_exp(num1, num2)
        return self.recv_exp()

    def send_exp(self, num1, num2):
    ...
    def recv_exp(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "exp failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_exp(self, seqid, iprot, oprot):
        ...
        result = exp_result()
        try:
            result.success = self._handler.exp(args.num1, args.num2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class sumavector_args(object):
    ...
    def __init__(self, sumandos=None,):
